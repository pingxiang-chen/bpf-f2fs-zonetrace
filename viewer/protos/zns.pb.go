...
type FileInfoResponse struct {
	...
	BlockHistogram map[int32]int32  `protobuf:"bytes,3,rep,name=block_histogram,json=blockHistogram,proto3" json:"block_histogram,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (x *FileInfoResponse) GetBlockHistogram() map[int32]int32 {
	if x != nil {
